...
export default defineConfig4CustomTheme < VdoingThemeConfig > ({
    ...
    themeConfig: {
        ...
        nav: [
            ...
            {
                text: '生财笔记',
                link: '/scbj/', // 目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
            },
            {
                text: '实操项目',
                link: '/scxm/'
        ...
        social: { // iconfontCssFile: '//at.alicdn.com/t/xxx.css', // 可选，阿里图标库在线css文件地址，对于主题没有的图标可自己添加。阿里图片库：https://www.iconfont.cn/
            icons: [
                // {
        ...
        footer: {
            ...
            copyrightInfo: 'SCSC', // 博客版权信息，支持a标签或换行标签</br>
        },
    ...
    head: [
        ...
        [
            'meta', {
                name: 'keywords',
                content: '偏门生意,冷门生意,暴利行业,灰产项目,赚快钱,暴利产品,赚钱门路,兼职项目,赚钱套路,捞偏门,赚钱项目'
            },
        ],
        [
            'meta', {
                name: 'description',
                content: '偏门项目网提供今年最新的偏门暴利项目；介绍最靠谱的赚钱门路和方法，分享各种偏门生意、兼职项目，助各位朋友轻轻松松赚大钱！'
            }
        ],
        [
            'meta', {
